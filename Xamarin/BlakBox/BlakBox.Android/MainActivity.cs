...
namespace BlakBox.Droid {
    [Activity(Label = "BlakBox", Icon = "@drawable/LoginIconSolid", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation, ScreenOrientation = ScreenOrientation.Landscape)]
